...
public class AdMobProvider : MonoBehaviour
{
    ...
    [SerializeField] private string androidRewardedId = "ca-app-pub-6988952582458184/7061184633";
    [SerializeField] private string androidInterstitialId = "ca-app-pub-6988952582458184/9211185343";
    [SerializeField] private string androidBannerId = "ca-app-pub-6988952582458184/4530693980";
    ...
    {
        Debug.Log($"IsRewardedReady = {IsRewardedReady}");
        Debug.Log($"_initialized = {_initialized}");
        Debug.Log($"_rewarded != null = {_rewarded != null}");
